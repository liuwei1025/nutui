/*!
 * @nutui/nutui v2.3.15 - signature.js, 5b6e8c7d5ef3d09d8ecb, Thu Sep 14 2023 13:58:10 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
      ...
      var s = n(53),
        i =
          (n(72),
          {
            ...
            props: {
              ...
              unSupportTpl: { type: String, default: '对不起，当前浏览器不支持Canvas，无法使用本控件！' },
            },
            data: function () {
              return {
                canvasHeight: 0,
            ...
            methods: {
              addEvent: function () {
                (this.startEventHandler = this.startEventHandler.bind(this)),
                  this.$refs.canvas.addEventListener(this.events[0], this.startEventHandler, !1);
              },
              startEventHandler: function (t) {
                t.preventDefault(),
                  this.ctx.beginPath(),
                  ...
                  this.$refs.canvas.addEventListener(this.events[1], this.moveEventHandler, !1),
                  this.$refs.canvas.addEventListener(this.events[2], this.endEventHandler, !1),
                  this.$refs.canvas.addEventListener(this.events[3], this.leaveEventHandler, !1);
              },
              moveEventHandler: function (t) {
                t.preventDefault();
                var e = this.isSupportTouch ? t.touches[0] : t,
                  n = this.$refs.canvas.getBoundingClientRect(),
                  s = e.clientX - n.left,
                  i = e.clientY - n.top;
                this.ctx.lineTo(s, i), this.ctx.stroke();
              },
              endEventHandler: function (t) {
                t.preventDefault(),
                  this.$refs.canvas.removeEventListener(this.events[1], this.moveEventHandler, !1),
                  this.$refs.canvas.removeEventListener(this.events[2], this.endEventHandler, !1);
              },
              leaveEventHandler: function (t) {
                t.preventDefault(),
                  this.$refs.canvas.removeEventListener(this.events[1], this.moveEventHandler, !1),
                  this.$refs.canvas.removeEventListener(this.events[2], this.endEventHandler, !1);
              },
              ...
              onSave: function (t) {
                ...
                switch (this.type) {
                  case 'png':
                    ...
                    break;
                  case 'jpg':
                    e = t.toDataURL('image/jpeg', 0.8);
                }
                this.clear(!0), this.$emit('confirm', t, e);
              },
            },
            mounted: function () {
        ...
        r = Object(o.a)(
          ...
          function () {
            ...
            return n(
              'div',
              { staticClass: 'nut-signature', class: t.customClass },
              [
                n('div', { ref: 'wrap', staticClass: 'nut-signature-inner' }, [
                  t.isCanvasSupported
                    ? n('canvas', { ref: 'canvas', attrs: { height: t.canvasHeight, width: t.canvasWidth } })
                    : n('p', { staticClass: 'nut-signature-unsopport' }, [t._v(t._s(t.unSupportTpl))]),
                ]),
                t._v(' '),
                t._t('default'),
                t._v(' '),
