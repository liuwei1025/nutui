/*!
 * @nutui/nutui v2.3.15 - notify.js, 5b6e8c7d5ef3d09d8ecb, Thu Sep 14 2023 13:58:10 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
...
!(function (t, e) {
  ...
  return (function (t) {
        ...
        f = {
          ...
          updateOverlay: function () {
            ...
            if (
              ...
              var i = o.vm,
                l = o.config,
                p = i.$el;
              p && p.parentNode && 11 !== p.parentNode.nodeType ? p.parentNode.appendChild(d.$el) : document.body.appendChild(d.$el),
                s()(d, l, { value: !0 });
            } else d.value = !1;
          },
          openModal: function (t, e) {
            var n = e.zIndex,
              ...
              i = e.overlayStyle,
              s = e.id;
            p.push({ vm: t, config: { id: s, zIndex: n, duration: o, overlayClass: r, overlayStyle: i } }), f.updateOverlay();
          },
          clickHandle: function () {
            var t = f.topStack;
            p.length && t.vm.closeOnClickOverlay && (t.vm.$emit('click-overlay'), t.vm.close());
          },
          closeOverlay: function (t) {
            p.length &&
              (f.topStack.vm === t
                ? (p.pop(), f.updateOverlay())
          ...
          methods: {
            open: function () {
              if (!this.opened) {
                ...
                this.renderOverlay(i),
                  this.lockScroll &&
                    (h(document, 'touchstart', this.touchStart),
                    h(document, 'touchmove', this.onTouchMove),
            ...
            onTouchMove: function (t) {
              ...
              var e = this.getScroller(t.target),
                ...
                r = n.offsetHeight,
                i = n.scrollTop;
              ((this.deltaY > 0 && 0 === i) || (this.deltaY < 0 && i + r >= o)) && t.cancelable && t.preventDefault();
            },
    ...
    function (t, e, n) {
      ...
      var o = n(47),
        r = (n(65), n(6));
      n.d(e, 'getProps', function () {
        return r.a;
      });
      var i = n(16);
      n.d(e, 'overlayProps', function () {
        return i.b;
      }),
    ...
    function (t, e, n) {
      ...
      var h = {
          ...
          props: p(
            ...
            {},
            {
              ...
              duration: { type: [Number, String], default: 3e3 },
          ...
          watch: {
            showPopup: {
              handler: function (t) {
                t && ((this.curVisible = t), this.show());
              },
            },
          },
          data: function () {
            return { timer: null, curVisible: !1 };
          },
          components: { 'nut-popup': u.a },
          methods: {
            handleClick: function () {
              'function' == typeof this.onClick && this.onClick();
            },
            handleOpened: function () {
              'function' == typeof this.onOpened && this.onOpened();
            },
            handleClosed: function () {
              'function' == typeof this.onClosed && this.onClosed();
            },
            show: function (t) {
              var e = this;
              this.clearTimer(),
        ...
        v = Object(f.a)(
          ...
          function () {
            ...
            return (t._self._c || e)(
              'nut-popup',
              {
                class: ['nut-notify', 'nut-notify--' + t.type, { className: t.className }],
                style: { color: t.color, background: t.background },
                attrs: { position: 'top', overlay: !1, lockScroll: !1 },
                on: { click: t.handleClick, opened: t.handleOpened, closed: t.handleClosed },
                model: {
                  value: t.curVisible,
                  callback: function (e) {
                    t.curVisible = e;
              ...
              [t.$slots.default ? [t._t('default')] : [t._v(t._s(t.msg))]],
              2
            );
          },
          [],
      ...
      function k(t) {
        ...
        return (
          r()(e, O, b[t.type], t),
          e.id && y[e.id] ? ((m = y[e.id]).hide(!0), (m = r()(m, e))) : ((m = new x({ propsData: e })), (m = r()(m, t)), e.id && (y[e.id] = m)),
          (m.vm = m.$mount()),
      ...
      var M = {
          text: function (t) {
            ...
            return S(t), k(w(w({}, e), {}, { msg: t }));
          },
          primary: function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return S(t), k(w(w({}, e), {}, { msg: t, type: 'primary' }));
          },
          success: function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return S(t), k(w(w({}, e), {}, { msg: t, type: 'success' }));
          },
          danger: function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return S(t), k(w(w({}, e), {}, { msg: t, type: 'danger' }));
          },
          warn: function (t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
            return S(t), k(w(w({}, e), {}, { msg: t, type: 'warning' }));
          },
          setDefaultOptions: function (t, e) {
            'string' == typeof t ? (b[t] = e) : r()(O, t);
          },
          resetDefaultOptions: function (t) {
            'string' == typeof t ? (b[t] = null) : ((O = w({}, C)), (b = {}));
          },
        },
        j = (n(148), [M, v]);
      j.install = function (t) {
        (t.prototype.$notify = M), t.component(v.name, v);
      };
      e.default = j;
    },
  ]);
