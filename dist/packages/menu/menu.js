/*!
 * @nutui/nutui v2.3.16 - menu.js, e52e9db51c8ff5aa6d12, Thu Sep 14 2023 23:19:08 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function n(s) {
      ...
      return t[s].call(l.exports, l, l.exports, n), (l.l = !0), l.exports;
    }
    return (
      (n.m = t),
      (n.c = e),
      ...
      (n.t = function (t, e) {
        ...
        if ((n.r(s), Object.defineProperty(s, 'default', { enumerable: !0, value: t }), 2 & e && 'string' != typeof t))
          for (var l in t)
            n.d(
              s,
              l,
        ...
        if (
          ...
          o
            ...
            : l &&
              (a = r
                ? function () {
                    l.call(this, (c.functional ? this.parent : this).$root.$options.shadowRoot);
                  }
                : l),
          a)
        )
    ...
    12: function (t, e, n) {
      ...
      var r = {
        ...
        u = function () {
          ...
          if ('function' == typeof t && o.a.locale)
            return (
              c || ((c = !0), o.a.locale(o.a.config.lang, l()('zn-CH' === o.a.config.lang ? r : {}, o.a.locale(o.a.config.lang) || {}, a))),
      ...
      function d(t, e) {
        ...
        if (null != n) return n;
        var s = l()({}, 'zn-CH' === o.a.config.lang ? r : {}, a),
          i = (t && t.split('.')) || [],
          c = null;
        if (i.length)
        ...
        return (
          n &&
            ...
            (n = n.map(function (t) {
              ...
              var l = new RegExp('{\\s*' + n + '\\s*(?:=\\s*(\\S*?))?\\s*?}', 'g');
              t = t.replace(l, function (t, s) {
                return 'function' ==
                  ((l = e[n]),
    ...
    184: function (t, e, n) {
      ...
      var s,
        ...
        c = {
          afterOpen: function () {
            (s = document.scrollingElement.scrollTop || document.body.scrollTop),
              document.body.classList.add('dialog-open'),
              (document.body.style.top = -s + 'px');
          },
          beforeClose: function () {
            document.body.classList.contains('dialog-open') &&
              (document.body.classList.remove('dialog-open'), (document.scrollingElement.scrollTop = s));
          },
        },
        u = {
          name: 'nut-menu',
          mixins: [a.a],
          components: { 'nut-button': i.a, 'nut-button-group': o.a, 'nut-checkbox': l.a, 'nut-icon': r.a },
          props: {
            isAnimation: { type: Boolean, default: !1 },
            isVisible: { type: Boolean, default: !1 },
            type: { type: String, default: 'simple' },
            col: { type: [Number, String], default: 1 },
            mulstyle: { type: [String], default: 'style1' },
          ...
          methods: {
            ...
            selectedItem: function (t, e) {
              this.$emit('choose', t, e);
            },
            selectMutiple: function (t) {
              if (!this.datalist[t].selected) {
                var e = 0;
                if (
                  ...
                  return void this.$emit('maxTip');
              }
              this.$set(this.datalist[t], 'selected', !this.datalist[t].selected);
            },
            resetMenu: function () {
            ...
            sureMenu: function () {
              this.$emit('close'), this.$emit('ok', this.datalist);
            },
          },
        },
        d = n(0),
              ...
              [
                n('transition', { attrs: { name: t.isAnimation ? '' : 'nutFade' } }, [
                  n('div', {
                    ...
                    on: { click: t.clickMenuMask },
                  }),
                ]),
                t._v(' '),
                n('transition', { attrs: { name: t.isAnimation ? '' : 'nutSlideDown' } }, [
                  n(
                    'div',
                    { directives: [{ name: 'show', rawName: 'v-show', value: t.isVisible, expression: 'isVisible' }], staticClass: 'nut-menu-panel' },
                    [
                      'simple' !== t.type || t.$slots.custom
                        ? t._e()
                        : n('div', { staticClass: 'menu-simple' }, [
                            n(
                              'ul',
                      ...
                      t._v(' '),
                      'multiple' === t.type && 'style1' === t.mulstyle
                        ? n(
                            'div',
                            ...
                            [
                              n(
                                ...
                                t._l(t.datalist, function (e, s) {
                                  return n(
                                    ...
                                    {
                                      key: s,
                                      class: { selected: !!e.selected, col2: 2 == t.col, col3: 3 == t.col },
                                      on: {
                                        click: function (e) {
                                          return t.selectMutiple(s);
                                        },
                                      },
                                    },
                                    [
                              ...
                              n(
                                'nut-button-group',
                                [
                                  n('nut-button', { attrs: { type: 'light' }, on: { click: t.resetMenu } }, [t._v(t._s(t.resetBtnTxt))]),
                                  t._v(' '),
                                  n('nut-button', { on: { click: t.sureMenu } }, [t._v(t._s(t.okBtnTxt))]),
                                ],
                                1
                              ),
                            ],
                        ...
                        : t._e(),
                      t._v(' '),
                      'multiple' === t.type && 'style2' === t.mulstyle
                        ? n(
                            'div',
                              ...
                              n(
                                ...
                                t._l(t.datalist, function (e, s) {
                                  return n(
                                    ...
                                    [n('a', { attrs: { href: 'javascript:void(0);' } }, [t._v(t._s(e.text))])]
                                  );
                                }),
                                0
                              ),
                        ...
                        : t._e(),
                      t._v(' '),
                      'multiple' === t.type && 'style3' === t.mulstyle
                        ? n(
                            'div',
                        ...
                        : t._e(),
                      t._v(' '),
                      t.$slots.custom ? n('div', { staticClass: 'menu-custom' }, [t._t('custom', [t._v(t._s(t.custom))])], 2) : t._e(),
                    ]
                  ),
                ]),
              ],
      ...
      var s = n(2),
        ...
        i = {
          ...
          methods: {
            ...
            looseEqual: function (t, e) {
              return t == e || (!(!this.isObject(t) || !this.isObject(e)) && JSON.stringify(t) === JSON.stringify(e));
            },
            changeEvt: function (t) {
              var e = this.isChecked,
                n = t.target.checked;
              this.$emit('input', n ? this.trueValue : this.falseValue, this.label, t),
                e !== n && this.$emit('change', n ? this.trueValue : this.falseValue, this.label, t);
            },
          },
        },
        o = n(0),
        r = Object(o.a)(
          ...
          function () {
            var t = this,
              e = t.$createElement,
              n = t._self._c || e;
            return n('label', { class: ['nut-checkbox', 'nut-checkbox-size-' + t.size] }, [
              n('input', {
                class: { 'nut-checkbox-ani': t.animation },
                attrs: { type: 'checkbox', name: t.name, disabled: t.disabled },
                domProps: { checked: t.isChecked, value: t.submittedValue },
                on: { change: t.changeEvt },
              }),
              t._v(' '),
              t.label
                ? n('span', { staticClass: 'nut-checkbox-label' }, [t._v('\n    ' + t._s(t.label) + '\n  ')])
                : n('span', { staticClass: 'nut-checkbox-label' }, [t._t('default')], 2),
            ]);
          },
          [],
          !1,
    ...
    8: function (t, e, n) {
      'use strict';
      var s = ['top', 'action', 'cross', 'down', 'right', 'more', 'notice', 'plus', 'search', 'trolley', 'tick', 'minus', 'circle-cross'],
        l = {
          name: 'nut-icon',
          props: {
            type: { type: String, default: '' },
