/*!
 * @nutui/nutui v2.3.16 - checkboxgroup.js, e52e9db51c8ff5aa6d12, Thu Sep 14 2023 23:19:08 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
            ...
            methods: {
              ...
              changeEvt: function (e, t) {
                if (!this.ignoreChange) {
                  ...
                  var u = this.looseIndexOf(this.value, n);
                  i && u < 0 && (s = this.value.concat(n)),
                    !i && u > -1 && (s = this.value.slice(0, u).concat(this.value.slice(u + 1))),
                    this.$emit('input', s),
                    this.$emit('change', s, o, a);
                }
              },
                  ...
                  [
                    n(
                      'nut-checkbox',
                      {
                        ...
                        model: {
                          value: e.checkboxValues[t[e.keys.id]],
                          callback: function (n) {
                            e.$set(e.checkboxValues, t[e.keys.id], n);
                          },
