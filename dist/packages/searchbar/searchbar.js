/*!
 * @nutui/nutui v2.3.16 - searchbar.js, e52e9db51c8ff5aa6d12, Thu Sep 14 2023 23:19:08 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
...
!(function (t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    ? define('searchbar', ['vue'], e)
    : 'object' == typeof exports
    ? (exports.searchbar = e(require('vue')))
    : (t.searchbar = e(t.Vue));
  ...
  return (function (t) {
    ...
    12: function (t, e, n) {
      ...
      var l = {
        ...
        c = !1,
        u = function () {
          var t = Object.getPrototypeOf(this || s.a).$t;
          if ('function' == typeof t && s.a.locale)
            return (
              c || ((c = !0), s.a.locale(s.a.config.lang, r()('zn-CH' === s.a.config.lang ? l : {}, s.a.locale(s.a.config.lang) || {}, a))),
      ...
      function h(t, e) {
        ...
        if (null != n) return n;
        var o = r()({}, 'zn-CH' === s.a.config.lang ? l : {}, a),
          i = (t && t.split('.')) || [],
          c = null;
        if (i.length)
      ...
      var o = n(4),
        ...
        s = {
          ...
          props: {
            ...
            searchIconSize: { type: String, default: '20px' },
            searchIconColor: { type: String, default: '#2e2d2d' },
            searchBtnIconSize: { type: String, default: '20px' },
            searchBtnIconColor: { type: String, default: '#2e2d2d' },
            clearIconSize: { type: String, default: '15px' },
            clearIconColor: { type: String, default: '#2e2d2d' },
            placeText: { type: String },
            hasSearchButton: { type: Boolean, default: !0 },
            hasTextButton: { type: Boolean, default: !1 },
            textInfo: { type: String },
            animation: { type: Boolean, default: !0 },
            customClass: { type: String, default: '' },
            value: { type: [String, Number], default: '' },
          },
          components: r()({}, i.a.name, i.a),
          data: function () {
            return { inputFocusAnimation: !1 };
          },
          watch: {
            value: function (t, e) {
          ...
          methods: {
            updateValue: function () {
              var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'input',
                e = 'change' == t ? this.value : this.$refs.searchInput.value;
              this.$emit(t, e);
            },
            clearInput: function () {
              this.$emit('clear', ''), this.$emit('input', '');
            },
            focusFun: function () {
              (this.inputFocusAnimation = !0), this.$emit('focus');
            },
            inputFun: function () {
              this.updateValue();
            },
            blurFun: function () {
              (this.inputFocusAnimation = !1), this.updateValue('blur');
            },
            submitFun: function () {
              document.activeElement && document.activeElement.blur(), this.updateValue('submit');
            },
            blur: function () {
        ...
        a = Object(l.a)(
          ...
          function () {
            var t = this,
              e = t.$createElement,
              n = t._self._c || e;
            return n('div', { class: ['nut-searchbar', t.customClass ? t.customClass : ''] }, [
              n('div', { staticClass: 'search-input', class: [t.animation ? 'nut-search-ani' : '', t.inputFocusAnimation ? 'focus' : ''] }, [
                n('form', { attrs: { id: 'input-form', action: 'javascript:return true' } }, [
                  t.hasIcon
                    ? n(
                        'div',
                        { staticClass: 'nut-search-left-icon', on: { click: t.clickLeftIcon } },
                        [
                          n('nut-icon', {
                            staticClass: 'nut-search-left-icon',
                            attrs: { type: 'search', size: t.searchIconSize, color: t.searchIconColor },
                          }),
                        ],
                        1
                      )
                  ...
                  n('input', {
                    ref: 'searchInput',
                    attrs: { type: 'search', placeholder: null == t.placeText ? t.nutTranslate('lang.searchbar.placeText') : t.placeText },
                    domProps: { value: t.value },
                    on: {
                      keyup: function (e) {
                        return !e.type.indexOf('key') && t._k(e.keyCode, 'enter', 13, e.key, 'Enter') ? null : t.submitFun(e);
                      },
                      input: t.inputFun,
                      blur: t.blurFun,
                      focus: t.focusFun,
                  ...
                  n(
                    'span',
                    { staticClass: 'close-icon', class: t.hasCloseIcon ? 'show' : '', on: { click: t.clearInput } },
                    [n('nut-icon', { attrs: { type: 'circle-cross', size: t.clearIconSize, color: t.clearIconColor } })],
                    1
                  ),
                ]),
              ]),
              ...
              t.hasSearchButton
                ? n(
                    'a',
                    { staticClass: 'btn-search', attrs: { href: 'javascript:;' }, on: { click: t.clickRightText } },
                    [
                      t.hasTextButton
                        ? n('span', [t._v(t._s(t.textInfo || t.nutTranslate('lang.searchbar.textInfo')))])
                        : n('nut-icon', { attrs: { type: 'search', size: t.searchBtnIconSize, color: t.searchBtnIconColor } }),
                    ],
                    1
                  )
                : t._e(),
