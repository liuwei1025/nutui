/*!
 * @nutui/nutui v2.3.15 - sidenavbar.js, 5b6e8c7d5ef3d09d8ecb, Thu Sep 14 2023 13:58:10 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    206: function (t, e, n) {
      ...
      var i = {
          name: 'nut-sidenavbar',
          props: { offset: { type: [String, Number], default: 15 } },
          mounted: function () {
            this.handleSlots(),
              (this.observer = new MutationObserver(
                function (t) {
                  (this.count = 1), this.handleSlots();
                }.bind(this)
              )),
              this.observer.observe(this.$refs.list, { attributes: !1, childList: !0, characterData: !1, subtree: !1 });
          },
          data: function () {
            return { count: 1, observer: null };
          },
          methods: {
            handleSlots: function () {
              var t = this.$slots.default;
              t &&
                ((t = t
                  .filter(function (t) {
                    return 3 !== t.elm.nodeType;
                  })
                  .map(function (t) {
                    return t.elm;
                  })),
                this.setPaddingLeft(t));
            },
            setPaddingLeft: function (t) {
              for (var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1, n = 0; n < t.length; n++) {
                var i = t[n];
                (i.children[0].style.paddingLeft = this.offset * e + 'px'),
                  i.className.includes('nut-sidenavbaritem') || this.setPaddingLeft(Array.from(i.children[1].children), ++this.count);
              }
              this.count--;
            },
          },
        ...
        r = Object(s.a)(
          ...
          function () {
            var t = this.$createElement,
              e = this._self._c || t;
            return e('div', { staticClass: 'nut-sidenavbar' }, [
              e('div', { staticClass: 'sidenavbar-content' }, [e('div', { ref: 'list', staticClass: 'sidenavbar-list' }, [this._t('default')], 2)]),
            ]);
          },
          [],
          !1,
      ...
      r.install = function (t) {
        t.component(r.name, r), t.component(o.a.name, o.a), t.component(l.a.name, l.a), t.component(a.a.name, a.a);
      };
      e.default = r;
    },
    21: function (t, e) {
