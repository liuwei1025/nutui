/*!
 * @nutui/nutui v2.3.15 - cell.js, 5b6e8c7d5ef3d09d8ecb, Thu Sep 14 2023 13:58:10 GMT+0800 (China Standard Time)
 * (c) 2017-2020 JDC
...
!(function (t, e) {
  ...
  return (function (t) {
    ...
    function n(i) {
      ...
      return t[i].call(l.exports, l, l.exports, n), (l.l = !0), l.exports;
    }
    return (
      (n.m = t),
      (n.c = e),
      ...
      var i = n(8),
        l = {
          ...
          props: {
            ...
            linkUrl: { type: String, default: 'javascript:void(0)' },
            showIcon: { type: Boolean, default: !1 },
            bgColor: { type: String, default: '#fff' },
            to: { type: String, default: '' },
            target: { type: String, default: '_self' },
          },
          components: { 'nut-icon': i.a },
          data: function () {
            return {};
          },
          methods: {
        ...
        o = Object(s.a)(
          ...
          function () {
            ...
            return n(
              'a',
              {
                class: ['nut-cell', { 'nut-cell-link': t.isLink }],
                style: { 'background-color': t.bgColor },
                attrs: { href: t.linkUrl, target: t.target },
                on: { click: t.jumpPage },
              },
              [
                n(
                  'div',
                  { staticClass: 'nut-cell-box', on: { click: t.clickCell } },
                  [
                    t._t('avatar'),
                    t._v(' '),
                    n('div', { staticClass: 'nut-cell-left' }, [
                      n('span', { staticClass: 'nut-cell-title' }, [t._t('title', [t._v(t._s(t.title))])], 2),
                      t._v(' '),
                      n('span', { staticClass: 'nut-cell-sub-title' }, [t._t('sub-title', [t._v(t._s(t.subTitle))])], 2),
                    ]),
                    t._v(' '),
                    n('div', { staticClass: 'nut-cell-right' }, [
                      n('span', { staticClass: 'nut-cell-desc' }, [t._t('desc', [t._v(t._s(t.desc))])], 2),
                      t._v(' '),
                      n(
                        'span',
                        { staticClass: 'nut-cell-icon' },
                        [t.showIcon ? t._t('icon', [n('nut-icon', { attrs: { type: 'right', size: '15px', color: '#848484' } })]) : t._e()],
                        2
                      ),
                    ]),
                  ],
